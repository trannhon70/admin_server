      ...
      <Card>
        ...
        <CardBody>
          <CardText className="mb-2 pb-1">
            Use of any product you buy from PIXINVENT is bound by the license
            you purchase. It will allow you the non-exclusive access to use it
            in your personal as well as client projects.
          </CardText>
          ...
          <CardText className="mb-2 pb-75">
            ...
            or your client project for 1 time. If you want to use it for
            multiple times, you need to buy another regular license every time.
            Ownership and Copyright of our template will stay with
            ThemeSelection after purchasing single license. That means you are
            allowed to use our template in your project and use for one client
            or yourself,
          </CardText>
          ...
          <ul className="ps-25 ms-1">
            ...
            <li>
              You can use our product for unlimited projects when end users are
              not charged.
            </li>
          </ul>
          <CardText className="mb-2 pb-75">
            With Multiple Use License you will be able to use our product for
            yourself as well as your client projects. You can use product for
            unlimited projects. Ownership and Copyright of our template will
            stay with ThemeSelection after purchasing multiple use license. That
            means you are allowed to use our template in your project and use
            for multiple clients and yourself, but you are not allowed to create
            SaaS application and sell that,
          </CardText>
          ...
          <CardText className="mb-2 pb-1">
            ...
            building one project. Ownership and Copyright of our template will
            remain with ThemeSelection and that means, you are not allowed to
            ...
            <div className="alert-body d-flex align-items-center justify-content-between flex-wrap p-2">
              <div className="me-1">
                ...
                <p className="fw-normal mb-1 mb-lg-0">
                  If you’ve mass production demand and other custom use cases
                  than we’re here to help you.
                </p>
              </div>

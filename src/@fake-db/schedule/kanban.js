...
// GET: Returns Boards
// ------------------------------------------------
mock.onGet("/schedule/kanban/boards").reply(() => {
...
// GET: Returns Tasks
// ------------------------------------------------
mock.onGet("/schedule/kanban/tasks").reply(() => {
...
// POST: Reorder Tasks
// ------------------------------------------------
mock.onPost("/schedule/kanban/reorder-tasks").reply((config) => {
...
// ------------------------------------------------
mock.onPost("/schedule/kanban/update-task-board").reply((config) => {
...
// POST: Adds Task
// ------------------------------------------------
mock.onPost("/schedule/kanban/add-task").reply((config) => {
...
// POST: Adds Board
// ------------------------------------------------
mock.onPost("/schedule/kanban/add-board").reply((config) => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost("/schedule/kanban/update-task").reply((config) => {
...
// ------------------------------------------------
mock.onDelete("/schedule/kanban/delete-board").reply((config) => {
...
// Delete: Clears Tasks
// ------------------------------------------------
mock.onDelete("/schedule/kanban/clear-tasks").reply((config) => {
  const Id = config.data;
  const filteredTasks = data.tasks.filter((t) => t.boardId !== Id);
  data.tasks = filteredTasks;
